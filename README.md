...
* **[optimization_algorithms_for_ai](https://github.com/HAYDARKILIC/optimization_algorithms_for_ai):** SSGD, Momentum, NAG, AdaGrad, RMSprop, Adam, AdamW, Lion, K-FAC, Adafactor, 8-bit Adam, Muon, Shampoo, SAM, LR Schedulers, plus the derivative-free half: Nelder-Mead, SPSA, zeroth-order Adam, CMA-ES, Differential Evolution, PSO, Cross-Entropy, PBT, Hyperband, Bayesian Optimization.
