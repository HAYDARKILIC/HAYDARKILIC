...
* **[optimization_algorithms_for_ai](https://github.com/HAYDARKILIC/optimization_algorithms_for_ai):** A nine-module, notebook-first course that derives, implements and benchmarks the optimization algorithms that actually train modern neural networks — from pure-NumPy SGD to Muon, Adafactor, K-FAC and 8-bit Adam.
